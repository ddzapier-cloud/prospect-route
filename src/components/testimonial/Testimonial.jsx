...
const TestimonialCard = ({ quote, company, name, isCenter }) => (
  <div style={{
    background: '#fff',
    borderRadius: '12px',
    ...
    /* ✅ Full width responsive — fixed px nahi */
    ...
    <div style={{
      ...
      <p className="text-center text-gray-700 text-base leading-relaxed">{quote}</p>
    </div>
    ...
    <div className="w-full py-10">
      <div style={{ width:'100%', overflow:'hidden' }}>
        <div style={{
          ...
          {/* ✅ Left — card width se match karta negative margin */}
          <div style={{ marginLeft: 'calc(-100vw + 900px)' }}>
            <TestimonialCard {...testimonialData[prev]} isCenter={false} />
          </div>

          {/* Center */}
          <TestimonialCard {...testimonialData[active]} isCenter={true} />

          {/* ✅ Right */}
          <div style={{ marginRight: 'calc(-100vw + 900px)' }}>
            <TestimonialCard {...testimonialData[next]} isCenter={false} />
          </div>
